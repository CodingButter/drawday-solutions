          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-night text-gray-400">Or continue with</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center px-4 py-2 border border-gray-700 rounded-lg text-gray-300 hover:text-white hover:border-gray-600 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
